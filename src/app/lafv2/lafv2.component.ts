...
@Component({
  selector: 'app-lafv2',
  templateUrl: './lafv2.component.html',
  styleUrls: ['./lafv2.component.css']
})
export class Lafv2Component implements OnInit {
  data = <any>{};
  data3 = <any>{};
  data1 = <any>{};
  totalexpense = [];
                ...
                res => {
                  ...
                  if(res.status == 200)
                  {
                    if(this.profession == true){
                      ...
                      this.data.dateofjoining = this.data3.dateofjoining,
                      ...
                      this.data.establishsince = this.data3.establishsince,
                      this.data.secp = this.data3.secp,
                      this.data.dateofreg = this.data3.dateofreg,
