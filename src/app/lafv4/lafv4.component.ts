...
@Component({
  selector: 'app-lafv4',
  templateUrl: './lafv4.component.html',
  styleUrls: ['./lafv4.component.css']
})
export class Lafv4Component implements OnInit {
  ...
  SECP = 'No Image';
  NTN = 'No Image';
  facilityLetter = 'No Image';//new
  loanApp1 = 'No Image';//new
  loanApp2 = 'No Image';//new
  verfication = "";
  userId = "";
  ...
  fileListImage13: FileList;//new
  fileListImage14: FileList;//new
  fileListImage15: FileList;//new
              ...
              res => {
                this.data3 = res.data;
                  if(this.data1[0].profession=="Salaried"){
                    ...
                    this.data.SECP = this.data3.SECP;//new
                    this.data.NTN = this.data3.NTN;//new
                    this.data.facilityLetter = this.data3.facilityLetter;//new
                    this.data.loanApp1 = this.data3.loanApp1;//new
                    this.data.loanApp2 = this.data3.loanApp2;//new
                  }
                  else {
                    this.data.cnicFront = this.data3.cnicFront;
                    this.data.cnicBack = this.data3.cnicBack;
  ...
  submitform(){
    ...
    //new
    if(this.facilityLetter != '' && this.facilityLetter != undefined && this.fileListImage13 != undefined){
      const fileImage8: File = this.fileListImage13[0];
      formData.append('facilityLetter', fileImage8, fileImage8.name);
    }
    //new
    if(this.loanApp1 != '' && this.loanApp1 != undefined && this.fileListImage14 != undefined){
      const fileImage9: File = this.fileListImage14[0];
      formData.append('loanApp1', fileImage9, fileImage9.name);
    }
    //new
    if(this.loanApp2 != '' && this.loanApp2 != undefined && this.fileListImage15 != undefined){
      const fileImage10: File = this.fileListImage15[0];
      formData.append('loanApp2', fileImage10, fileImage10.name);
    }
  ...
  //new
  uploadImageFacilityLetter(event : any) {
    this.fileListImage13 = event.target.files;
    this.facilityLetter = this.fileListImage13[0].name;
  }
  //new
  uploadImageLoanApp1(event : any) {
    this.fileListImage14 = event.target.files;
    this.loanApp1 = this.fileListImage14[0].name;
  }
  //new
  uploadImageLoanApp2(event : any) {
    this.fileListImage15 = event.target.files;
    this.loanApp2 = this.fileListImage15[0].name;
  }
